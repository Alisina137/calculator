...
const persian = {
  ...
  reuseResult: "استفاده از نتیجه",
  reuseExpression: "استفاده از عبارت",
  delete: "حذف",
  clearAll: "پاک کردن همه",
  clearHistory: "پاک کردن تاریخچه",
  confirmClearHistoryTitle: "پاک کردن همه تاریخچه؟",
  confirmClearHistoryBody: "این کار قابل بازگشت نیست.",
  cancel: "لغو",
  confirm: "پاک کردن",
  language: "زبان",
  numerals: "نوع اعداد",
...
const dari: Record<keyof typeof persian, string> = {
  ...
  confirmClearHistoryTitle: "همه تاریخچه پاک شود؟",
  confirmClearHistoryBody: "این کار دوباره قابل برگشت نیست.",
  cancel: "لغو",
  confirm: "پاک کردن",
  appearance: "نمایش",
  privacy: "محرمیت",
